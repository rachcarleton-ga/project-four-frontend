...
const ArrivedJournal = ({ journal, setEditTrigger }) => {
  ...
  return (
    <div className="journal-entry-card">
      ...
      {editMode ? (
        <>
          <input type="text" value={journalToBeEdited.picture} onChange={(e) =>
              setJournalToBeEdited({ ...journalToBeEdited, picture: e.target.value })}/>
          <input type="text" value={journalToBeEdited.date} onChange={(e) =>
              setJournalToBeEdited({ ...journalToBeEdited, date: e.target.value })}/>
          <input type="text" value={journalToBeEdited.diary} onChange={(e) =>
